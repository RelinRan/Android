...
/**
 * Created by Relin on 2016/5/18.
 */
public class MeasureStaggeredGridLayoutManager extends StaggeredGridLayoutManager {

    private int space = 0;

    public MeasureStaggeredGridLayoutManager(int spanCount, int orientation, int space) {
    ...
    public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int widthSpec, int heightSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            //LogUtils.d("LISTENER", "position " + i + " height = " + measuredDimension[1]);
        ...
        if (position < getItemCount()) {
            try {
                ...
                if (view != null) {
                    ...
                    space = position==getChildCount()-1?0:space;
                    measuredDimension[1] = view.getMeasuredHeight() + lp.topMargin + lp.bottomMargin + space;
