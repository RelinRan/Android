...
import com.android.widget.SwipeMenuAdapter;
...
public class SwipeMenuListView extends ListView {
    ...
    public void setAdapter(ListAdapter adapter) {
        super.setAdapter(new SwipeMenuAdapter(getContext(), adapter) {
            ...
            @Override
            public void onItemClick(SwipeMenuView view, SwipeMenuView.SwipeMenu menu,
                                    int index) {
                boolean flag = false;
    ...
    public static interface OnMenuItemClickListener {
        boolean onMenuItemClick(int position, SwipeMenuView.SwipeMenu menu, int index);
    }
    ...
    public interface SwipeMenuCreator {
        ...
        void create(SwipeMenuView.SwipeMenu menu);
    }
