...
public class TextGroupView extends LinearLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            leftHintTextColor = typedArray.getColor(R.styleable.TextGroupView_left_textHintTextColor, Color.GRAY);
            leftHintText = typedArray.getString(R.styleable.TextGroupView_left_textHintText);
            ...
            centerHintTextColor = typedArray.getColor(R.styleable.TextGroupView_center_textHintTextColor, Color.GRAY);
            centerHintText = typedArray.getString(R.styleable.TextGroupView_center_textHintText);
            ...
            rightHintTextColor = typedArray.getColor(R.styleable.TextGroupView_right_textHintTextColor, Color.GRAY);
            rightHintText = typedArray.getString(R.styleable.TextGroupView_right_textHintText);
        ...
        leftTextView.setHint(leftHintText);
        leftTextView.setHintTextColor(leftHintTextColor);
        ...
        rightTextView.setHint(rightHintText);
        rightTextView.setHintTextColor(rightHintTextColor);
    ...
    public int getLeftHintTextColor() {
        return leftHintTextColor;
    }

    public void setLeftHintTextColor(int leftHintTextColor) {
        this.leftHintTextColor = leftHintTextColor;
        leftTextView.setHintTextColor(leftHintTextColor);
    }

    public String getLeftHintText() {
        return leftHintText;
    }

    public void setLeftHintText(String leftHintText) {
        this.leftHintText = leftHintText;
        leftTextView.setHint(leftHintText);
    }

    public int getCenterHintTextColor() {
        return centerHintTextColor;
    }

    public void setCenterHintTextColor(int centerHintTextColor) {
    ...
    public void setCenterHintText(String centerHintText) {
        this.centerHintText = centerHintText;
        centerTextView.setHint(centerHintText);
    }

    public int getRightHintTextColor() {
        return rightHintTextColor;
    }

    public void setRightHintTextColor(int rightHintTextColor) {
        this.rightHintTextColor = rightHintTextColor;
        rightTextView.setHintTextColor(rightHintTextColor);
    }
